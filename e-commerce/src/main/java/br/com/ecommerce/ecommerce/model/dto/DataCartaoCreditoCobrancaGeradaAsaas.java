...
public class DataCartaoCreditoCobrancaGeradaAsaas {
    ...
    private CartaoCreditoData creditCard = new CartaoCreditoData();

    public CartaoCreditoData getCreditCard() {
        return creditCard;
    }

    public void setCreditCard(CartaoCreditoData creditCard) {
